...
export class ShareDataModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ShareDataModalComponent>,
  ...
  onShareClick(): void {
    this.dialogRef.close({ result: true, selectedFolder: this.selectedFolder, selectedFile: this.selectedFile });
  }
